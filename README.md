...
| [`canon-fanfic-vignette`](canon-fanfic-vignette/SKILL.md) | Write short, standalone vignettes/journals/columns using named characters from an existing franchise, scoped to personal non-commercial fan work rather than a serialized retelling. Seed skill — three personas: Luke Skywalker as a kyber prospector, Shaggy & Scooby's forced-vacation mystery log, Garfield as a food critic. |
